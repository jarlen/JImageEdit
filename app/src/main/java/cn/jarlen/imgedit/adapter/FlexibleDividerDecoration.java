...
public abstract class FlexibleDividerDecoration extends RecyclerView.ItemDecoration {
    ...
    protected int mFirstDividerSize;
    protected int mFirstDividerColor;
    ...
    protected FlexibleDividerDecoration(Builder builder) {
        ...
        mFirstDividerColor = builder.mFirstDividerColor;
        mFirstDividerSize = builder.mFirstDividerSize;
    }
    ...
    public void onDraw(Canvas c, RecyclerView parent, RecyclerView.State state) {
        ...
        for (int i = 0; i < validChildCount; i++) {
            ...
            if (!mShowLastDivider && childPosition >= itemCount - lastDividerOffset && !mShowFirstDivider) {
            ...
            switch (mDividerType) {
                ...
                case COLOR:
                    if (childPosition == 0 && mShowFirstDivider) {
                        Rect firstBounds = getDividerFirstBound(groupIndex, parent, child);
                        mPaint.setColor(mFirstDividerColor);
                        mPaint.setStrokeWidth(mFirstDividerSize);
                        c.drawLine(firstBounds.left, firstBounds.top, firstBounds.right, firstBounds.bottom, mPaint);
                    }
    ...
    public void getItemOffsets(Rect rect, View v, RecyclerView parent, RecyclerView.State state) {
        ...
        int lastDividerOffset = getLastDividerOffset(parent);
        if (!mShowLastDivider && position >= itemCount - lastDividerOffset && !mShowFirstDivider) {
    ...
    protected abstract Rect getDividerFirstBound(int position, RecyclerView parent, View child);
    ...
    /**
     * Interface for controlling divider mFirstDividerColor
     */
    ...
    public static class Builder<T extends Builder> {
        ...
        protected boolean mShowFirstDivider = false;
        ...
        public T showFirstDivider(@Dimension int dividerSize, @ColorInt int color) {
            this.mFirstDividerSize = dividerSize;
            this.mFirstDividerColor = color;
            ...
            if (mPaintProvider != null) {
                if (mColorProvider != null) {
                    throw new IllegalArgumentException(
                            "Use setColor method of Paint class to specify line mFirstDividerColor. Do not provider ColorProvider if you set PaintProvider.");
                }
                if (mSizeProvider != null) {
                    throw new IllegalArgumentException(
